...
android {
    namespace = "com.rankerz.screenbrightness.feature.perapp" // Updated namespace
...
dependencies {
    ...
    // implementation(project(":data:local")) // Likely needed for app profiles
    // implementation(project(":data:system")) // May need for app detection
